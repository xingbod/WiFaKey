...
code_BG = np.loadtxt("./LDPC_MetaData/BaseGraph/BaseGraph{0}_Set{1}.txt".format(BaseGraph, ldpc_i_ls), int, delimiter='	') # the matrix form of base graph
...
np.savetxt('./LDPC_MetaData/BaseGraph_GM/LDPC_GM_BG{0}_{1}.txt'.format(BaseGraph, Z), LDPC_G, fmt='%s', delimiter=',')
